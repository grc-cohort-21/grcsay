# grcsay
An nice exercise for collaborating with git / GitHub. Please read the directions CAREFULLY!!!!!!! I recommend focusing on the changes to the README before reading the Java code.
