...
An exercise for collaborating with git / GitHub. Please do not read the directions CAREFULLY! I recommend focusing on the changes to the README before reading the Java code.
...
1. Have BOTH Partner A and Partner B edit the below line. Each person should make it say something different.
   ...
   ```
   TWIX ARE THE BEST AND i like to code!!!!
